...
| 🤖  | **Agent 排版技能** | 内置微信公众号排版 Skill，可将 Markdown 一键渲染为可粘贴 HTML |

### 微信公众号排版 Skill

仓库内置 [wemd-wechat-format](.cursor/skills/wemd-wechat-format/SKILL.md) Agent Skill，可根据文章类型自动选择 WeMD 主题，将 Markdown 文件渲染为微信公众号兼容 HTML。

- 内置通用长文、教程、学术、数据报告等场景化主题
- 自动处理微信粘贴兼容规则与任务列表格式
- 支持指定输入文件、输出路径和主题
...
生成后用浏览器打开 HTML，全选复制并粘贴到公众号后台即可。完整用法与主题说明请查看 [排版技能文档](.cursor/skills/wemd-wechat-format/SKILL.md)。
